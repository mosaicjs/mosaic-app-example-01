...
const { ListView,  ListPaginationView } = AppUi.views.list;
const { AutocompleteBox } = AppUi.views.autocomplete;
const { SearchCriteriaDataSet } = AppUi.views.search;
...
// this._tagsSearchCriteria = new DataSetSelection({dataSet: model.tags});
